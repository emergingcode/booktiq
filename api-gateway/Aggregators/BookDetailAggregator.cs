...
namespace ApiGgatewayBFF.Aggregators
{
    public class BookDetailsAggregator : IDefinedAggregator
    {
        ...
        //    try
        //    {
        //        var book = await responses[0].DownstreamResponse.Content.ReadAsAsync<Book>();

        //        try
        //        {
        //            var price = await responses[1].DownstreamResponse.Content.ReadAsAsync<BookPrice>();
        //            var rating = await responses[2].DownstreamResponse.Content.ReadAsAsync<BookRating>();
